...
abstract class Table implements CRUD
{
    ...
    public function insert(array $obj) : bool
    {
        try {
            ...
            $this->setAffectedCols($stmt->columnCount());
     ...
     * @param mixed $value
     * @return object
     * @example: $tb->uniqueField('email', 'exemplo@gmail.com';
     * */
    public function uniqueField(string $field, $value) : object
    {
        try {
            $sql = "SELECT * FROM {$this->tableName}
                    WHERE {$field} = :value;";
     ...
     * @return int
     */
    public function getAffectedCols() : int
    {
        return $this->affectedCols;
    }
     ...
     * @param int $affectedRows
     */
    public function setAffectedCols(int $affectedCols) : void
    {
